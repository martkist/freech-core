...
public:
    CMainParams() {
        ...
        //   vMerkleTree: 4a5e1e
        const char* pszTimestamp = "The Times 23/Jan/2023 Recession is coming, but economists are split on how bad it will be.";
        CTransaction txNew;
        ...
        genesis.nVersion = 1;
        genesis.nHeight  = 0;
        genesis.nTime    = 1674478831;
        //genesis.nBits    = 0x1d00ffff;
        genesis.nBits    = 0x1f03ffff;
        genesis.nNonce   = 4078;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("fd27b9a8444c887df19b1eb2296173cb99334e3e0a7ae17cd84ce4d291462371"));

        vSeeds.push_back(CDNSSeedData("martkist.org", "seed.martkist.org"));
